...
#_(defn consolidate-grouped-transactions
  [[_ transactions]]
  (->> transactions
       (sort-by :transaction/created-at)
       (reduce #(transaction->portfolio %1 %2) {})))

#_(defn filter-operation
  [transaction]
  (filter #(contains?
...
#_(defn set-portfolio-representation
